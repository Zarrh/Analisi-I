...
\begin{center}
  ...
  \addplot[domain=0:1, smooth, thick, blue]
      {x};

  \addplot[domain=0:1, smooth, thick, amber]
      {x^2};

  \addplot[domain=0:1, smooth, thick, teal]
      {x^3};

  \addplot[domain=0:1, smooth, thick, tyrian]
      {x^4};

  \addplot[domain=0:1, smooth, thick, purple]
      {x^8};
...
\begin{es}[III]
  ...
  \begin{center}
    ...
    \addplot[domain={1/3}:1, smooth, thick, blue]
        {0};

    \draw[smooth, thick, blue] (0, 0) -- ({1/(2*3)}, {2*3}) -- ({1/3}, 0);
...
\begin{center}
  ...
  \addplot[domain=0:6.28, smooth, thick, blue]
      {sin(deg(x))};

  \addplot[domain=0:6.28, smooth, thick, amber]
      {sin(deg(x))-3*sin(deg(x))*(-1)^1/(1)^2};

  \addplot[domain=0:6.28, smooth, thick, teal]
      {sin(deg(x))-3*sin(deg(x))*(-1)^2/(2)^2};

  \addplot[domain=0:6.28, smooth, thick, tyrian]
...
\begin{define}[Raggio di convergenza]
