...
\begin{tikzpicture}[scale=1.2, >=stealth]
  ...
  \coordinate (Z) at (2,1);
  \draw[thick, cmapteal-300, ->] (0,0) -- (Z);
  \filldraw[cmapteal-300] (Z) circle (2pt);
  \node[black, above right] at (Z) {$z$};
  \node[cmapteal-300] at (1.0,0.8) {$\rho$};
  ...
  % Argument angle
  \draw[->, thick, cmapteal-500] (0.8,0) arc (0:26.565:0.8);
  \node[cmapteal-500!80!black] at (1.2,0.3) {$\vartheta$};
...
\begin{tikzpicture}[scale=3, thick]
  ...
  \foreach \k in {0,1,2,3,4} {
    ...
    \filldraw[cmapteal-300, z=10] (P\k) circle(0.02);
  }

  % Connect the points to form a pentagon
  \draw[cmapteal-300, very thick] (P0) -- (P1) -- (P2) -- (P3) -- (P4) -- cycle;
